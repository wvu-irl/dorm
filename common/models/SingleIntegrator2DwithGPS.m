classdef SingleIntegrator2DwithGPS < GenericStateSpaceModel
    %% Properties
    properties (Constant = true)
        x_dim_ = 2; %x and y position, x and y velocity
        u_dim_ = 2; %x and y velocities
        w_dim_ = 2; %noise in x and y velocities
    ...
    methods
        %% Constructor
        function obj = SingleIntegrator2DwithGPS(sigma_vx,...
                                                 sigma_vy,...
                                                 sigma_x,...
                                                 sigma_y,...
                                                 dt,...
            ...
            obj.Q_ = diag([sigma_vx^2, sigma_vy^2]);
