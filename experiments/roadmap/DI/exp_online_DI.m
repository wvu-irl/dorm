...
[eig_dorm] = bsp.run_online(x0,...
                            ...
                            1);        %method
G_dorm = bsp.G_;
data_dorm = fn_get_data_DI(bsp, x_goal, G_dorm, P0, eig_dorm);
...
[eig_brms] = bsp.run_online(x0,...
                            ...
                            2);       %method
G_brms = bsp.G_;
data_brms = fn_get_data_DI(bsp, x_goal, G_brms, P0, eig_brms);
...
[eig_brm] = bsp.run_online(x0,...
                           ...
                           3);       %method
G_brm = bsp.G_;
data_brm = fn_get_data_DI(bsp, x_goal, G_brm, P0, eig_brm);
...
% hold on;
% h_brm=fn_plot_path_DI(x_goal, G_brm, [0,0,1]);

%plot path BRMS
disp('Plotting path BRMS...');
hold on;
h_brms=fn_plot_path_DI(x_goal, G_brms, [1,0,0]);

%plot path DORM
disp('Plotting path DORM...');
hold on;
h_dorm=fn_plot_path_DI(x_goal, G_dorm, [1,1,0]);
...
% 
% %22
% axis([0,200,10^(-20),10^(20)])
% yticks([10^(-15),10^(0),10^(15)]);
